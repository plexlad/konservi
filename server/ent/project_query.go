...
type ProjectQuery struct {
	...
	withOwner       *UserQuery
	withMemberships *ProjectMembershipQuery
...
func (_q *ProjectQuery) QueryMemberships() *ProjectMembershipQuery {
...
func (_q *ProjectQuery) QueryEntries() *EntryQuery {
...
func (_q *ProjectQuery) QueryPeople() *PersonQuery {
...
func (_q *ProjectQuery) QueryFamilies() *FamilyQuery {
...
func (_q *ProjectQuery) Clone() *ProjectQuery {
	...
	return &ProjectQuery{
		...
		withFamilies:    _q.withFamilies.Clone(),
...
func (_q *ProjectQuery) WithMemberships(opts ...func(*ProjectMembershipQuery)) *ProjectQuery {
	query := (&ProjectMembershipClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProjectQuery) WithEntries(opts ...func(*EntryQuery)) *ProjectQuery {
	query := (&EntryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProjectQuery) WithPeople(opts ...func(*PersonQuery)) *ProjectQuery {
	query := (&PersonClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProjectQuery) WithFamilies(opts ...func(*FamilyQuery)) *ProjectQuery {
	query := (&FamilyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withFamilies = query
	return _q
}
...
func (_q *ProjectQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Project, error) {
	...
	if query := _q.withMemberships; query != nil {
		if err := _q.loadMemberships(ctx, query, nodes,
			func(n *Project) { n.Edges.Memberships = []*ProjectMembership{} },
			func(n *Project, e *ProjectMembership) { n.Edges.Memberships = append(n.Edges.Memberships, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withEntries; query != nil {
		if err := _q.loadEntries(ctx, query, nodes,
			func(n *Project) { n.Edges.Entries = []*Entry{} },
			func(n *Project, e *Entry) { n.Edges.Entries = append(n.Edges.Entries, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withPeople; query != nil {
		if err := _q.loadPeople(ctx, query, nodes,
			func(n *Project) { n.Edges.People = []*Person{} },
			func(n *Project, e *Person) { n.Edges.People = append(n.Edges.People, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withFamilies; query != nil {
		if err := _q.loadFamilies(ctx, query, nodes,
			func(n *Project) { n.Edges.Families = []*Family{} },
			func(n *Project, e *Family) { n.Edges.Families = append(n.Edges.Families, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ProjectQuery) loadMemberships(ctx context.Context, query *ProjectMembershipQuery, nodes []*Project, init func(*Project), assign func(*Project, *ProjectMembership)) error {
...
func (_q *ProjectQuery) loadEntries(ctx context.Context, query *EntryQuery, nodes []*Project, init func(*Project), assign func(*Project, *Entry)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Project)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(entry.FieldProjectID)
	}
	query.Where(predicate.Entry(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(project.EntriesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ProjectQuery) loadPeople(ctx context.Context, query *PersonQuery, nodes []*Project, init func(*Project), assign func(*Project, *Person)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Project)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(person.FieldProjectID)
	}
	query.Where(predicate.Person(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(project.PeopleColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ProjectQuery) loadFamilies(ctx context.Context, query *FamilyQuery, nodes []*Project, init func(*Project), assign func(*Project, *Family)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Project)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(family.FieldProjectID)
	}
	query.Where(predicate.Family(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(project.FamiliesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
