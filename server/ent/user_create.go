...
func (_c *UserCreate) SetEditedLastAt(v time.Time) *UserCreate {
	_c.mutation.SetEditedLastAt(v)
	return _c
}

// SetNillableEditedLastAt sets the "edited_last_at" field if the given value is not nil.
func (_c *UserCreate) SetNillableEditedLastAt(v *time.Time) *UserCreate {
	if v != nil {
...
func (_c *UserCreate) AddEntryIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddEntryIDs(ids...)
	return _c
}

// AddEntries adds the "entries" edges to the Entry entity.
func (_c *UserCreate) AddEntries(v ...*Entry) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddMemberships(v ...*ProjectMembership) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.EditedLastAt(); !ok {
		return &ValidationError{Name: "edited_last_at", err: errors.New(`ent: missing required field "User.edited_last_at"`)}
	}
	return nil
}
