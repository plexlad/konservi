...
func HasMembershipsWith(preds ...predicate.ProjectMembership) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
...
func HasEntries() predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEntriesWith(preds ...predicate.Entry) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := newEntriesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasPeople() predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasPeopleWith(preds ...predicate.Person) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := newPeopleStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasFamilies() predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasFamiliesWith(preds ...predicate.Family) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := newFamiliesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
