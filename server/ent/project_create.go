...
func (_c *ProjectCreate) AddMemberships(v ...*ProjectMembership) *ProjectCreate {
...
func (_c *ProjectCreate) AddEntryIDs(ids ...uuid.UUID) *ProjectCreate {
	_c.mutation.AddEntryIDs(ids...)
	return _c
}

// AddEntries adds the "entries" edges to the Entry entity.
func (_c *ProjectCreate) AddEntries(v ...*Entry) *ProjectCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *ProjectCreate) AddPersonIDs(ids ...uuid.UUID) *ProjectCreate {
	_c.mutation.AddPersonIDs(ids...)
	return _c
}

// AddPeople adds the "people" edges to the Person entity.
func (_c *ProjectCreate) AddPeople(v ...*Person) *ProjectCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *ProjectCreate) AddFamilyIDs(ids ...uuid.UUID) *ProjectCreate {
	_c.mutation.AddFamilyIDs(ids...)
	return _c
}

// AddFamilies adds the "families" edges to the Family entity.
func (_c *ProjectCreate) AddFamilies(v ...*Family) *ProjectCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddFamilyIDs(ids...)
}
...
func (_c *ProjectCreate) createSpec() (*Project, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.FamiliesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
