...
func (e ProjectEdges) MembershipsOrErr() ([]*ProjectMembership, error) {
	if e.loadedTypes[1] {
...
// was not loaded in eager-loading.
func (e ProjectEdges) EntriesOrErr() ([]*Entry, error) {
	if e.loadedTypes[2] {
...
// was not loaded in eager-loading.
func (e ProjectEdges) PeopleOrErr() ([]*Person, error) {
	if e.loadedTypes[3] {
		return e.People, nil
	}
...
// was not loaded in eager-loading.
func (e ProjectEdges) FamiliesOrErr() ([]*Family, error) {
	if e.loadedTypes[4] {
...
func (_m *Project) QueryMemberships() *ProjectMembershipQuery {
	return NewProjectClient(_m.config).QueryMemberships(_m)
}

// QueryEntries queries the "entries" edge of the Project entity.
func (_m *Project) QueryEntries() *EntryQuery {
	return NewProjectClient(_m.config).QueryEntries(_m)
}

// QueryPeople queries the "people" edge of the Project entity.
func (_m *Project) QueryPeople() *PersonQuery {
	return NewProjectClient(_m.config).QueryPeople(_m)
}

// QueryFamilies queries the "families" edge of the Project entity.
func (_m *Project) QueryFamilies() *FamilyQuery {
	return NewProjectClient(_m.config).QueryFamilies(_m)
}
